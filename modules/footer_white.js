        ...
        <section className="py-12 bg-white">
            <main className="max-w-screen-xl flex flex-col mx-auto">
                <div className="flex items-center justify-between">
                    ...
                    <div>
                        <div className="px-8 py-6 rounded-lg bg-black">
                        ...
                        <h3 className="text-s font-shadow text-black mt-10">
                        ...
                        <div className="mt-3 flex items-center">
                            <Image
                                ...
                                alt="Phone icon"
                            />
                            <p className="ml-3 text-black font-raleway">209-212-4753</p>
                        </div>
                        <div className="mt-3 flex items-center">
                            <Image
                                src={Mail}
                                ...
                                alt="Mail icon"
                            />
                            <p className="ml-3 text-black font-raleway">info@spookykitchen.com</p>
                        </div>
                    ...
                    <div className='flex flex-col text-center'>
                        ...
                        <ul className="mt-4 font-medium text-black">
                            <Link href="/">
